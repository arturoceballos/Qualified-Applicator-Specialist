		...
		<div class="error_bg" style="background:rgba(<?php 
			...
			?>">
				<section class="content_wrap fullwidth">
					...
					'<h2 class="error_subtitle">' . esc_html__("We're sorry, but the page you were looking for doesn't exist.", 'cmsmasters') . '</h2>';
					...
					if ($cmsms_option[CMSMS_SHORTNAME . '_error_sitemap_button'] && $cmsms_option[CMSMS_SHORTNAME . '_error_sitemap_link'] != '') {
						echo '<div class="error_button_wrap"><a href="' . esc_url($cmsms_option[CMSMS_SHORTNAME . '_error_sitemap_link']) . '" class="button">' . esc_html__('Sitemap', 'cmsmasters') . '</a></div>';
					}
					?>
				</section>
			</div>
