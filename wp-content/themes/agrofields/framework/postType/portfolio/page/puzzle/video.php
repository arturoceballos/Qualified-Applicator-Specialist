...
<article id="post-<?php the_ID(); ?>" <?php post_class($cmsms_project_size); echo (($project_categs != '') ? ' data-category="' . $project_categs . '"' : '') ?>>
	...
	<?php 
		cmsms_thumb_rollover(get_the_ID(), $project_img_size, $rollover, true, false, false, $cmsms_project_video_type, $cmsms_project_video_link, $cmsms_project_video_links, false, true, $cmsms_project_link_redirect, $cmsms_project_link_url);
