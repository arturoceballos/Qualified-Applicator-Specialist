		...
		echo '<div class="project_sidebar">';
			...
			if ($project_details == 'true') {
				echo '<div class="project_details entry-meta">' . 
					...
					'<h5 class="project_details_title">' . $cmsms_project_details_title . '</h5>';
					...
					cmsms_project_features('details', $cmsms_project_features, false, 'h5', true);
			...
			cmsms_project_features('features', $cmsms_project_features_one, $cmsms_project_features_one_title, 'h5', true);
			
			cmsms_project_features('features', $cmsms_project_features_two, $cmsms_project_features_two_title, 'h5', true);
			
			cmsms_project_features('features', $cmsms_project_features_three, $cmsms_project_features_three_title, 'h5', true);
			
			
			if ($cmsms_project_sharing_box == 'true') {
				cmsms_sharing_box(esc_html__('Like this project?', 'cmsmasters'), 'h5');
			}
