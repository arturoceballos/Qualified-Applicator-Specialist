...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	if ($cmsms_profile_title == 'true') {
		echo '<header class="cmsms_profile_header entry-header">' . 
			'<div class="cmsms_profile_header_inner">';
		...
		echo '<div class="profile_sidebar">';
			...
			if ($profile_details == 'true') {
				echo '<div class="profile_details entry-meta">' . 
					...
					'<h3 class="profile_details_title">' . $cmsms_profile_details_title . '</h3>';
					
					cmsms_profile_features('details', $cmsms_profile_features, false, 'h3', true);
			...
			cmsms_profile_features('features', $cmsms_profile_features_one, $cmsms_profile_features_one_title, 'h3', true);
			
			cmsms_profile_features('features', $cmsms_profile_features_two, $cmsms_profile_features_two_title, 'h3', true);
			
			cmsms_profile_features('features', $cmsms_profile_features_three, $cmsms_profile_features_three_title, 'h3', true);
