...
function cmsms_options_style_fields($set_tab = false) {
	...
	case 'logo':
		...
		$options[] = array( 
			'section' => 'logo_section', 
			'id' => CMSMS_SHORTNAME . '_logo_resp_url', 
			'title' => __('Logo Image For Small Resolutions', 'cmsmasters'), 
			'desc' => __('Choose your website logo image.', 'cmsmasters'), 
			'type' => 'upload', 
			'std' => '|' . get_template_directory_uri() . '/img/logo_resp.png', 
			'frame' => 'select', 
			'multiple' => false 
		);
		...
		$options[] = array( 
			'section' => 'logo_section', 
			'id' => CMSMS_SHORTNAME . '_logo_resp_url_retina', 
			'title' => __('Retina Logo Image For Small Resolutions', 'cmsmasters'), 
			'desc' => __('Choose logo image for retina displays.', 'cmsmasters'), 
			'type' => 'upload', 
			'std' => '|' . get_template_directory_uri() . '/img/logo_resp_retina.png', 
			'frame' => 'select', 
			'multiple' => false 
		);
	...
	case 'header':
		...
		$options[] = array( 
			...
			'choices' => array( 
				...
				__('Center Navigation', 'cmsmasters') . '|c_nav', 
				__('Right Navigation', 'cmsmasters') . '|r_nav'
			) 
		);
	...
	case 'content':
		...
		$options[] = array( 
			...
			'desc' => __('color transparency (percentage)', 'cmsmasters'),
			'type' => 'rgba', 
			'std' => '' 
		);
		...
		$options[] = array( 
			...
			'title' => __('Standard Heading Title by Default', 'cmsmasters'), 
			'desc' => __('show', 'cmsmasters'), 
			'type' => 'checkbox', 
			'std' => 1 
		);
	...
	case 'footer':
		...
		$options[] = array( 
			...
			'std' => 'small', 
			'choices' => array( 
				__('With logo', 'cmsmasters') . '|default', 
