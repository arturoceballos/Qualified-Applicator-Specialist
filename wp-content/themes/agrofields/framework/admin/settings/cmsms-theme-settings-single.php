...
function cmsms_options_single_tabs() {
	...
	$tabs['post'] = esc_attr__('Post', 'cmsmasters');
	
	if (class_exists('Cmsms_Projects')) {
		$tabs['project'] = esc_attr__('Project', 'cmsmasters');
	}
	
	if (class_exists('Cmsms_Profiles')) {
		$tabs['profile'] = esc_attr__('Profile', 'cmsmasters');
	}
	
	if (class_exists('Cmsms_Donations')) {
		$tabs['campaign'] = esc_attr__('Campaign', 'cmsmasters');
	}
...
function cmsms_options_single_sections() {
	...
	case 'post':
		...
		$sections['post_section'] = esc_attr__('Blog Post Options', 'cmsmasters');
	...
	case 'project':
		...
		$sections['project_section'] = esc_attr__('Portfolio Project Options', 'cmsmasters');
	...
	case 'profile':
		...
		$sections['profile_section'] = esc_attr__('Person Block Profile Options', 'cmsmasters');
	...
	case 'campaign':
		...
		$sections['campaign_section'] = esc_attr__('Donations Campaign Options', 'cmsmasters');
...
function cmsms_options_single_fields($set_tab = false) {
	...
	case 'post':
		...
		$options[] = array( 
			'section' => 'post_section', 
			'id' => CMSMS_SHORTNAME . '_blog_post_color', 
			'title' => __('Post Highlight Color', 'cmsmasters'), 
			'desc' => '', 
			'type' => 'color', 
			'std' => '#ff8f3c' 
		);
	...
	case 'campaign':
		$options[] = array( 
			...
			'title' => __('Campaign Title', 'cmsmasters'), 
			'desc' => __('show', 'cmsmasters'), 
			'type' => 'checkbox', 
			'std' => 1 
		);
		...
		$options[] = array( 
			...
			'title' => __('Campaign Date', 'cmsmasters'), 
			'desc' => __('show', 'cmsmasters'), 
			'type' => 'checkbox', 
			'std' => 1 
		);
		...
		$options[] = array( 
			...
			'title' => __('Campaign Categories', 'cmsmasters'), 
			'desc' => __('show', 'cmsmasters'), 
			'type' => 'checkbox', 
			'std' => 1 
		);
		...
		$options[] = array( 
			...
			'title' => __('Campaign Comments', 'cmsmasters'), 
			'desc' => __('show', 'cmsmasters'), 
			'type' => 'checkbox', 
			'std' => 0 
		);
		...
		$options[] = array( 
			...
			'title' => __('Campaign Tags', 'cmsmasters'), 
			'desc' => __('show', 'cmsmasters'), 
			'type' => 'checkbox', 
			'std' => 0 
		);
		...
		$options[] = array( 
			...
			'title' => __('Campaign Likes', 'cmsmasters'), 
			'desc' => __('show', 'cmsmasters'), 
			'type' => 'checkbox', 
			'std' => 0 
		);
		...
		$options[] = array( 
			...
			'title' => __('Campaign Navigation Box', 'cmsmasters'), 
			'desc' => __('show', 'cmsmasters'), 
			'type' => 'checkbox', 
			'std' => 1 
		);
		...
		$options[] = array( 
			...
			'title' => __('More Campaigns Box', 'cmsmasters'), 
			'desc' => '', 
			'type' => 'multi-checkbox', 
			'std' => array( 
				'related' => 'true', 
		...
		$options[] = array( 
			...
			'title' => __('Related, Popular & Latest Campaigns Boxes Items Number', 'cmsmasters'), 
			'desc' => __('campaigns', 'cmsmasters'), 
			'type' => 'number', 
			'std' => '4', 
			'min' => '2', 
			'max' => '10', 
		...
		$options[] = array( 
			...
			'title' => __('Campaign Slug', 'cmsmasters'), 
			'desc' => __('Enter a page slug that should be used for your donations campaign single item', 'cmsmasters'), 
			'type' => 'text', 
			'std' => 'campaign', 
			'class' => '' 
		);
