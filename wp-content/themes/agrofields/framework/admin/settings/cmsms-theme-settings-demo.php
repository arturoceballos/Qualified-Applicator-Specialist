...
function cmsms_options_demo_tabs() {
	...
	$tabs['import'] = esc_attr__('Import', 'cmsmasters');
	$tabs['export'] = esc_attr__('Export', 'cmsmasters');
...
function cmsms_options_demo_sections() {
	...
	case 'import':
		...
		$sections['import_section'] = esc_html__('Theme Settings Import', 'cmsmasters');
	...
	case 'export':
		...
		$sections['export_section'] = esc_html__('Theme Settings Export', 'cmsmasters');
